...
if __name__ == '__main__':
    ...
    print('\n'.join(ssids))
    ssid = input("Provide ssid of the network You want to connect to: ")
    key = getpass("Provide password to this network: ")
    wc.set_wifi_credentials(ssid, key)
    wc.connect_wifi()
    print("You've got 60 seconds to test your connection...")
